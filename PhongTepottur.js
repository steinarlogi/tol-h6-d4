...
window.onload = function init() {
    ...
    sizeOfDiscardLoc = gl.getUniformLocation(program, "sizeOfDiscard");

    gl.uniform1f(sizeOfDiscardLoc, sizeOfDiscard);
     ...
     window.addEventListener("keydown", function(e) {
         switch(e.keyCode) {
            ...
            case 37:
                ...
                let tempColor = convertToRGB(colorNumber);
                gl.uniform4fv( gl.getUniformLocation(program, "diffuseProduct"), flatten(tempColor) );
            ...
            case 39:
                ...
                let tempColor2 = convertToRGB(colorNumber);
                gl.uniform4fv( gl.getUniformLocation(program, "diffuseProduct"), flatten(tempColor2) );
                console.log(colorNumber);
                break;
         }
     });
